...
- **You cannot be offended if we close a PR** or otherwise decide not to merge your work. We're maintaining cinaworker for (many, many) others, and we're ultimately the ones that have to maintain the code. This is especially true if we believe your PR to be AI driven without any human-in-the-loop review or explanation. Not all ideas or work makes it. If it's critical to your workflow, you can fork it!
...
**First**: AI tooling is incredibly powerful, and enabled much of cinaworker itself to exist! But it's a tool: and the wielder of the tool is ultimately responsible for their output.
